public class ZeroShake extends Shake{
    ...
    public ZeroShake(String baseIng1, String baseIng2){
        super(baseIng1, baseIng2);
    }

    public ZeroShake setAdditionalIng1(String additionalIng1) {
        this.additionalIng1 = additionalIng1;
        return this;
    }

    public ZeroShake setAdditionalIng2(String additionalIng2) {
        this.additionalIng2 = additionalIng2;
        return this;
    }

    public ZeroShake setBasePrice(int basePrice) {
